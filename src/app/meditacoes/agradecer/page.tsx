// src/app/meditacoes/agradecer/page.tsx
"use client";
...
// Dados de exemplo para as meditações de Gratidão (serão usados como fallback)
const meditacoesAgradecerStatic: Meditacao[] = [
  {
    id: "agradecer001",
...
export default function MeditacoesGratidaoPage() {
  const [meditacoes, setMeditacoes] = useState<Meditacao[]>(meditacoesAgradecerStatic);
        ...
        if (!querySnapshot.empty) {
          const meditacoesData = querySnapshot.docs.map(doc => {
            ...
            return {
              ...
              texto: data.texto,
              categoria: "agradecer" // Garantindo que a categoria esteja correta para o link
            };
          });
