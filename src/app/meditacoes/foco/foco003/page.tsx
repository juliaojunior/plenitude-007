// src/app/meditacoes/foco/foco003/page.tsx
"use client";
...
const meditacao = {
  ...
  textoBiblico: "Finalmente, irmãos, tudo o que é verdadeiro, tudo o que é nobre, tudo o que é correto, tudo o que é puro, tudo o que é amável, tudo o que é de boa fama, se alguma virtude há e se algum louvor existe, seja isso o que ocupe o vosso pensamento. (Filipenses 4:8)",
