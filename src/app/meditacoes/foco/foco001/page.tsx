// src/app/meditacoes/foco/foco001/page.tsx
"use client";
...
const meditacao = {
  ...
  textoBiblico: "Tudo o que fizerem, façam de todo o coração, como para o Senhor, e não para os homens. (Colossenses 3:23)",
