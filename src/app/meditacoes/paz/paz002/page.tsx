// src/app/meditacoes/paz/paz002/page.tsx
"use client";
...
const meditacao = {
  ...
  textoBiblico: "Os que confiam no Senhor são como o monte Sião, que não se pode abalar, mas permanece para sempre. (Salmos 125:1)",
