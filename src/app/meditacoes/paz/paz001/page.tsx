// src/app/meditacoes/paz/paz001/page.tsx
"use client";
...
const meditacao = {
  ...
  textoBiblico: "Deixo-lhes a paz; a minha paz lhes dou. Não a dou como o mundo a dá. Não se perturbe o seu coração, nem tenham medo. (João 14:27)",
