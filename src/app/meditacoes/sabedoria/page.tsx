...
// Dados de exemplo para as meditações de Sabedoria (serão usados como fallback)
const meditacoesSabedoriaStatic: Meditacao[] = [
  {
    id: "sabedoria001",
...
export default function MeditacoesSabedoriaPage() {
  const [meditacoes, setMeditacoes] = useState<Meditacao[]>(meditacoesSabedoriaStatic);
        ...
        if (!querySnapshot.empty) {
          const meditacoesData = querySnapshot.docs.map(doc => {
            ...
            return {
              ...
              texto: data.texto,
              categoria: "sabedoria" // Garantindo que a categoria esteja correta para o link
            };
          });
