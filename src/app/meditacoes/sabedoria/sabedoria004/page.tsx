// src/app/meditacoes/sabedoria/sabedoria004/page.tsx
"use client";
...
const meditacao = {
  ...
  textoBiblico: "O coração do sábio adquire o conhecimento, e o ouvido dos sábios busca a ciência. (Provérbios 18:15)",
