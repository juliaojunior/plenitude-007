// src/app/meditacoes/ansiedade/ansiedade001/page.tsx
"use client";

import Link from "next/link";
import { ArrowLeft } from "lucide-react"; // Ícone para voltar

// Dados da meditação (poderiam vir de um CMS ou banco de dados no futuro)
const meditacao = {
  id: "ansiedade001",
  titulo: "Respiração Consciente para Acalmar",
  textoBiblico: "Não andem ansiosos por coisa alguma, mas em tudo, pela oração e súplicas, e com ação de graças, apresentem seus pedidos a Deus. E a paz de Deus, que excede todo o entendimento, guardará os seus corações e as suas mentes em Cristo Jesus. (Filipenses 4:6-7)",
  audioUrl: "/audio/placeholder_meditacao.mp3", // Caminho para um áudio de exemplo
  categoria: "ansiedade",
  categoriaNome: "Ansiedade" // Nome da categoria para o link de "voltar"
};
